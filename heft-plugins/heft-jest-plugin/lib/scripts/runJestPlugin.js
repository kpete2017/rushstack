...
async function runAsync(options) {
    ...
    await JestPlugin_1.JestPlugin._runJestAsync(options.scopedLogger, options.heftConfiguration, options.debugMode, options.properties, jestPluginOptions);
}
exports.runAsync = runAsync;
//# sourceMappingURL=runJestPlugin.js.map