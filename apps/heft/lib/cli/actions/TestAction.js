...
class TestAction extends BuildAction_1.BuildAction {
    ...
    onDefineParameters() {
        ...
        this._updateSnapshotsFlag = this.defineFlagParameter({
            ...
            description: 'Update Jest snapshots while running the tests.' +
        ...
        this._findRelatedTests = this.defineStringListParameter({
            ...
            description: 'Find and run the tests that cover a space separated list of source files that' +
        ...
        */
        ...
        this._testNamePattern = this.defineStringParameter({
            ...
            argumentName: 'REGEXP',
            description: 'Run only tests with a name that matches a regular expression.' +
        ...
        this._testPathPattern = this.defineStringListParameter({
            ...
            argumentName: 'REGEXP',
            description: 'Run only tests with a source file path that matches a regular expression.' +
        ...
        this._debugHeftReporter = this.defineFlagParameter({
            ...
            description: 'Normally Heft installs a custom Jest reporter so that test results are presented consistently' +
